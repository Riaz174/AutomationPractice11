...
public class Utilities {
  ...
  @BeforeMethod
    public void Browsers(String browsers, String Wbsite) {
		  if(browsers.equalsIgnoreCase("Chrome")) {
			  ...
			  System.setProperty("webdriver.edge.driver", "C:\\Users\\riaz_\\git\\repository25\\AutomationPractice11\\Driver\\msedgedriver.exe");
  ...
  public void shots() throws IOException {
	  ...
	  org.openqa.selenium.io.FileHandler.copy(ks, new File("C:\\Users\\riaz_\\git\\repository25\\AutomationPractice11\\Pictures\\"+sd+"picturesOfWebsite.jpg"));
	   //use FileHandler class from selenium
  }
